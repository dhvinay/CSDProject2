%---------------------------------------------------------------------------
%  MATLAB function for configuration set generated on 25-Nov-2013 11:01:12
%  MATLAB version: 8.2.0.701 (R2013b)
%---------------------------------------------------------------------------

function cs=Config_C_One_100ms()
...
cs.set_param('CodeInterfacePackaging', 'Nonreusable');   % Code interface packaging
cs.set_param('CodeReplacementLibrary', 'C89/C90 (ANSI)');   % Code replacement library 
