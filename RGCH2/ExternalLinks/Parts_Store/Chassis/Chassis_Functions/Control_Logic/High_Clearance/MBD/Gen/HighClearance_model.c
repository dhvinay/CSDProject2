...
static boolean_T HighClearance_model_leaveActiveState(void);
...
static boolean_T HighClearance_model_leaveActiveState(void)
{
  ...
  /* Inport: '<Root>/manualOverride' */
  /* Graphical Function 'leaveActiveState': '<S7>:1675' */
  /* Transition: '<S7>:1677' */
  if (((HighClearance_model_FuncInternalData0.stopBtn_prev !=
       ...
       ((HighClearance_model_FuncInternalData0.prevTargetState ==
         heightMovingDown_e) ||
        (HighClearance_model_FuncInternalData0.prevTargetState ==
         heightMovingUp_e))) || (HighClearance_model_U.manualOverride != 0))
  {
    /* Transition: '<S7>:1684' */
    /* Transition: '<S7>:1688' */
    /* Transition: '<S7>:1692' */
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          /* Transition: '<S7>:1722' */
          if (HighClearance_model_noMovementErr())
          {
            /* Transition: '<S7>:1679' */
            /* Transition: '<S7>:1735' */
            /* Transition: '<S7>:1739' */
          ...
          {
            /* Transition: '<S7>:1743' */
            if ((HighClearance_model_FuncInternalData0.downBtn_prev !=
...
static void HighClearance_model_active(void)
{
  ...
  if (HighClearance_model_leaveActiveState())
  {
    /* Transition: '<S7>:1732' */
  ...
  else
  {
    ...
    else if ((HighClearance_model_FuncInternalData0.downBtn_prev !=
              HighClearance_model_FuncInternalData0.downBtn_start) &&
             (HighClearance_model_FuncInternalData0.downBtn_start == 1) &&
...
void HighClearance_model_step(void)
{
  ...
  HighClearance_model_FuncInternalData0.stopBtn_prev =
    HighClearance_model_FuncInternalData0.stopBtn_start;
  HighClearance_model_FuncInternalData0.stopBtn_start =
    HighClearance_model_U.mfa.stopBtn;
  HighClearance_model_FuncInternalData0.downBtn_prev =
    HighClearance_model_FuncInternalData0.downBtn_start;
  HighClearance_model_FuncInternalData0.downBtn_start =
    HighClearance_model_U.mfa.downBtn;
  HighClearance_model_FuncInternalData0.upBtn_prev =
    HighClearance_model_FuncInternalData0.upBtn_start;
  HighClearance_model_FuncInternalData0.upBtn_start =
  ...
  {
    HighClearance_model_states(&LogicalOperator);
  }
  ...
  /* Chart: '<S29>/heightOkayFL' */
  HighClearance_model_heightOkayFL(targetState, rtb_uDLookupTable,
  ...
  HighClearance_model_heightOkayFL(targetState, rtb_uDLookupTable1,
  ...
  HighClearance_model_heightOkayFL(targetState, rtb_uDLookupTable2,
  ...
  HighClearance_model_heightOkayFL(targetState, Switch_m, rtb_uDLookupTable,
  ...
  targetState = HighClearance_model_FuncInternalData0.targetState_start;
  ...
  else
  {
    ...
    if (targetState != HighClearance_model_FuncInternalData0.targetState_start)
    {
      /* Transition: '<S19>:28' */
